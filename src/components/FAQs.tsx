...
const FAQs = () => {
  return (
  <div className='bg-black text-white bg-gradient-to-b from-[#5D2CA8] to to-black py-[72px] sm:py-24'>
  <div className="container">
    <h2 className='text-center text-5xl sm:text-6xl sm:max-w-[648px] mx-auto font-bold tracking-tight'>Frequently asked questions</h2>
